...
"""
Created on Sun Aug 25 13:36:56 2019
...
def Bridge_VGG16(input_shape, classes):
...
#    The shape of bridge_pool_3: 7 x 7 x 512
    ...
    model = Model(inputs = inputs, outputs = output, name = 'bridge_vgg16')
    plot_model(model, to_file = 'model_bridge_vgg16.png',show_shapes = True, show_layer_names = True)
