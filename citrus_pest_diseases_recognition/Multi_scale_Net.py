...
"""
Created on Mon Apr 15 09:28:45 2019
...
#    The shape of Pool_2: 28 x 28 x 128
    ...
    SE_1 = squeeze_excite_block(Pool_2, ratio = 4)
#    The shape of SE_1: 28 x 28 x 128   
...
#    The shape of Pool_4: 14 x 14 x 512
    ...
    SE_2 = squeeze_excite_block(Pool_4, ratio = 4)
#    The shape of SE_2: 14 x 14 x 512 
...
#    The shape of Pool_4: 7 x 7 x 512
    ...
    SE_3 = squeeze_excite_block(Pool_5, ratio = 4)
#    The shape of SE_3: 7 x 7 x 512
...
#    The shape of x: 1 x 1 x 1152
    
    output = Dense(1152, activation = 'relu', name = 'fc_1')(x)
    output = Dropout(0.5)(output)
    output = Dense(classes, activation = 'softmax', name = 'fc_2')(output)
    
    model = Model(inputs = inputs, outputs = output, name = 'multi_scale_net')
    plot_model(model, to_file = 'model_super.png',show_shapes = True, show_layer_names = True)
