...
def pyramid(x, filters):
    z1 = bridge(x, filters)
#    Mix information from different building blocks
    
    z2 = convolution(z1, filters=filters, kernel_size=(3, 3))
    z3 = convolution(z2, filters=filters, kernel_size=(3, 3))   
    
    out = Add()([z2, z3])
#    Add information of different receptive fields sizes
