...
"""
Created on Fri Apr 19 15:28:16 2019
...
#    The shape of Pool_4: 7 x 7 x 512
    ...
    model = Model(inputs = inputs, outputs = output, name = 'Rnet_v1')
    plot_model(model, to_file = 'model_Rv1.png',show_shapes = True, show_layer_names = True)
