...
"""
Created on Sun Jun 23 14:57:33 2019
...
def BaseNet(input_shape, classes):
...
#    The shape of x_10: 7 x 7 x 512
    ...
    model = Model(inputs = inputs, outputs = x, name = 'Base_small')
    plot_model(model, to_file = 'BaseNet_small.png',show_shapes = True, show_layer_names = True)
