...
"""
Created on Wed Jun 19 09:28:07 2019
...
def _residual_block(inputs, filters, block):
    channel_axis = 1 if K.image_data_format() == 'channels_first' else -1
    base_name = 'residual' + '_' + str(block)
...
#    The shape of x_10: 7 x 7 x 512
    ...
    model = Model(inputs = inputs, outputs = x, name = 'ResNet_small')
    plot_model(model, to_file = 'ResNet_small.png',show_shapes = True, show_layer_names = True)
