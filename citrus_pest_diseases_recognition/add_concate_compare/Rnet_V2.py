...
#    The shape of x_1: 112 x 112 x 32
    ...
    x_2 = _concatenate_block(inputs = x_1, filters = 32, block = 1)
#    The shape of x_2: 112 x 112 x 64
    
    x_3 = _trans_layer(inputs = x_2, block = 1)
#    The shape of x_3: 56 x 56 x 64
    
    x_4 = _concatenate_block(inputs = x_3, filters = 64, block = 2)
#    The shape of x_4: 56 x 56 x 128
    
    x_5 = _trans_layer(inputs = x_4, block = 2)
#    The shape of x_5: 28 x 28 x 128
    
    x_6 = _concatenate_block(inputs = x_5, filters = 128, block = 3)
#    The shape of x_6: 28 x 28 x 256
    
    x_7 = _trans_layer(inputs = x_6, block = 3)
#    The shape of x_7: 14 x 14 x 256
    
    x_8 = _concatenate_block(inputs = x_7, filters = 256, block = 4)
#    The shape of x_8: 14 x 14 x 512
    
    x_9 = _trans_layer(inputs = x_8, block = 4)
#    The shape of x_9: 7 x 7 x 512
    
    x_10 = _concatenate_block(inputs = x_9, filters = 512, block = 5)
#    The shape of x_10: 7 x 7 x 1024
    
    x = GlobalAveragePooling2D()(x_10)
#    The shape of x: 1 x 1024
    
    x = Dense(512, activation = 'relu', name = 'fc_1')(x)
    x = Dropout(0.5)(x)
    x = Dense(classes, activation = 'softmax', name = 'fc_2')(x)
    
    model = Model(inputs = inputs, outputs = x, name = 'RNet_small_v2')
    plot_model(model, to_file = 'RNet_small_v2.png',show_shapes = True, show_layer_names = True)
