...
#    The shape of Pool_5: 7 x 7 x 512
    ...
    x_bridge_1 = _bridge_block(inputs = x_7, filters = 256, block = 1)
#    The shape of x_bridge_1: 28 x 28 x 256
    
    Pool_bridge_1 = MaxPooling2D(pool_size = (2, 2), strides = (2, 2), padding = 'same', 
                          name = 'MaxPool_bridge_1')(x_bridge_1)
#    The shape of Pool_bridge_1: 14 x 14 x 256
    
    x_bridge_2 = Concatenate(axis = -1)([Pool_bridge_1, Pool_4])
#    The shape of x_bridge_2: 14 x 14 x 768
    
    x_bridge_3 = _bridge_block(inputs = x_bridge_2, filters = 512, block = 2)
#    The shape of x_bridge_3: 14 x 14 x 512
    
    Pool_bridge_2 = MaxPooling2D(pool_size = (2, 2), strides = (2, 2), padding = 'same', 
                          name = 'MaxPool_bridge_2')(x_bridge_3)
#    The shape of Pool_bridge_2: 7 x 7 x 512
    
    x_bridge_4 = Concatenate(axis = -1)([Pool_bridge_2, Pool_5])
#    The shape of x_bridge_4: 7 x 7 x 1024
    
    x_bridge_5 = _bridge_block(inputs = x_bridge_4, filters = 512, block = 3)
#    The shape of x_bridge_5: 7 x 7 x 512
    
    output = GlobalAveragePooling2D()(x_bridge_5)
    ...
    plot_model(model, to_file = 'model_bridge_densenet.png',show_shapes = True, show_layer_names = True)
