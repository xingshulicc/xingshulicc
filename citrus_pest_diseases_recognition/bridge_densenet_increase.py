...
#    The shape of Pool_5: 7 x 7 x 512
    ...
    x_bridge_1 = _bridge_block(inputs = x_5, filters = 128, block = 1)
#    The shape of x_bridge_1: 28 x 28 x 128
    
    Pool_bridge_1 = MaxPooling2D(pool_size = (2, 2), strides = (2, 2), padding = 'same', 
                          name = 'MaxPool_bridge_1')(x_bridge_1)
#    The shape of Pool_bridge_1: 14 x 14 x 128
    
    x_bridge_2 = Concatenate(axis = -1)([Pool_bridge_1, Pool_3])
#    The shape of x_bridge_2: 14 x 14 x 384
    
    x_bridge_3 = _bridge_block(inputs = x_bridge_2, filters = 256, block = 2)
#    The shape of x_bridge_3: 14 x 14 x 256
    
    x_bridge_4 = Concatenate(axis = -1)([x_bridge_3, Pool_4])
#    The shape of x_bridge_4: 14 x 14 x 768
    
    x_bridge_5 = _bridge_block(inputs = x_bridge_4, filters = 512, block = 3)
...
#    The shape of x_bridge_7: 7 x 7 x 512
    ...
    model = Model(inputs = inputs, outputs = output, name = 'bridge_denseNet_v3')
    plot_model(model, to_file = 'model_bridge_densenet_increase.png',show_shapes = True, show_layer_names = True)
